...
The results of the stationary test show that the first difference in the GDP time series is stationary. Due to this, we reject the hypothesis in all tests.

The results of the normality test show that the first difference in the GDP time series is not normal because the null hypothesis for both tests is rejected.
